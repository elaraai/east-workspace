                              ...
                              Beast2StringTableDec *st)
{
    ...
    size_t slen;
    char *s = read_string_varint(data, len, offset, &slen);
    if (!s) return strdup("");
    char *dup = strdup(s);
    free(s);
    return dup;
                             ...
                             Beast2StringTableDec *st)
{
    ...
    if (dist == 0) {
        ...
        for (uint64_t i = 0; i < loc_count; i++) {
            ...
            if (st) read_varint(data, offset); else { size_t slen; char *s = read_string_varint(data, len, offset, &slen); free(s); }
                                    ...
                                    Beast2StringTableDec *st)
{
    ...
    case 3: /* Float */   return east_float(read_float64_le(data, offset));
    ...
    case 6: /* String */ {
        ...
        size_t slen; char *s = read_string_varint(data, len, offset, &slen);

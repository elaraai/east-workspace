...
static void dict_key_not_found_error(EastValue *key)
{
    ...
    char msg[512];
    snprintf(msg, sizeof(msg), "Dict does not contain key %s", printed ? printed : "?");
    free(printed);
...
static void dict_key_already_exists_error(EastValue *key)
{
    char *printed = east_print_value(key, s_dict_key_type);
    char msg[512];
    snprintf(msg, sizeof(msg), "Dict already contains key %s", printed ? printed : "?");
    free(printed);
    east_builtin_error(msg);
}
...
static EastValue *dict_delete_impl(EastValue **args, size_t n)
{
    ...
    EastValue *d = args[0];
    EastValue *key = args[1];
    if (east_dict_delete(d, key)) return east_null();
...
static BuiltinImpl dict_generate_factory(EastType **tp, size_t ntp)
{
    (void)tp;
    (void)ntp;
    return dict_generate_impl;
}
static BuiltinImpl dict_size_factory(EastType **tp, size_t ntp)
{
    (void)tp;
    (void)ntp;
    return dict_size_impl;
}
static BuiltinImpl dict_has_factory(EastType **tp, size_t ntp)
{
    (void)tp;
    (void)ntp;
    return dict_has_impl;
}
...
static BuiltinImpl dict_get_or_default_factory(EastType **tp, size_t ntp)
{
    (void)tp;
    (void)ntp;
    return dict_get_or_default_impl;
}
...
static BuiltinImpl dict_get_or_insert_factory(EastType **tp, size_t ntp)
{
    (void)tp;
    (void)ntp;
    return dict_get_or_insert_impl;
}
static BuiltinImpl dict_insert_or_update_factory(EastType **tp, size_t ntp)
{
    (void)tp;
    (void)ntp;
    return dict_insert_or_update_impl;
}
static BuiltinImpl dict_merge_factory(EastType **tp, size_t ntp)
{
    (void)tp;
    (void)ntp;
    return dict_merge_impl;
}
static BuiltinImpl dict_try_delete_factory(EastType **tp, size_t ntp)
{
    (void)tp;
    (void)ntp;
    return dict_try_delete_impl;
}
static BuiltinImpl dict_clear_factory(EastType **tp, size_t ntp)
{
    (void)tp;
    (void)ntp;
    return dict_clear_impl;
}
static BuiltinImpl dict_union_in_place_factory(EastType **tp, size_t ntp)
{
    (void)tp;
    (void)ntp;
    return dict_union_in_place_impl;
}
static BuiltinImpl dict_merge_all_factory(EastType **tp, size_t ntp)
{
    (void)tp;
    (void)ntp;
    return dict_merge_all_impl;
}
static BuiltinImpl dict_keys_factory(EastType **tp, size_t ntp)
{
    (void)tp;
    (void)ntp;
    return dict_keys_impl;
}
static BuiltinImpl dict_get_keys_factory(EastType **tp, size_t ntp)
{
    (void)tp;
    (void)ntp;
    return dict_get_keys_impl;
}
static BuiltinImpl dict_for_each_factory(EastType **tp, size_t ntp)
{
    (void)tp;
    (void)ntp;
    return dict_for_each_impl;
}
static BuiltinImpl dict_copy_factory(EastType **tp, size_t ntp)
{
    (void)tp;
    (void)ntp;
    return dict_copy_impl;
}
static BuiltinImpl dict_map_factory(EastType **tp, size_t ntp)
{
    (void)tp;
    (void)ntp;
    return dict_map_impl;
}
static BuiltinImpl dict_filter_factory(EastType **tp, size_t ntp)
{
    (void)tp;
    (void)ntp;
    return dict_filter_impl;
}
static BuiltinImpl dict_filter_map_factory(EastType **tp, size_t ntp)
{
    (void)tp;
    (void)ntp;
    return dict_filter_map_impl;
}
static BuiltinImpl dict_first_map_factory(EastType **tp, size_t ntp)
{
    (void)tp;
    (void)ntp;
    return dict_first_map_impl;
}
static BuiltinImpl dict_map_reduce_factory(EastType **tp, size_t ntp)
{
    (void)tp;
    (void)ntp;
    return dict_map_reduce_impl;
}
static BuiltinImpl dict_reduce_factory(EastType **tp, size_t ntp)
{
    (void)tp;
    (void)ntp;
...
static BuiltinImpl dict_to_array_factory(EastType **tp, size_t ntp)
{
    (void)tp;
    (void)ntp;
    return dict_to_array_impl;
}
static BuiltinImpl dict_to_set_factory(EastType **tp, size_t ntp)
{
    (void)tp;
    (void)ntp;
    return dict_to_set_impl;
}
static BuiltinImpl dict_to_dict_factory(EastType **tp, size_t ntp)
{
    (void)tp;
    (void)ntp;
    return dict_to_dict_impl;
}
static BuiltinImpl dict_flatten_to_array_factory(EastType **tp, size_t ntp)
{
    (void)tp;
    (void)ntp;
    return dict_flatten_to_array_impl;
}
static BuiltinImpl dict_flatten_to_set_factory(EastType **tp, size_t ntp)
{
    (void)tp;
    (void)ntp;
    return dict_flatten_to_set_impl;
}
static BuiltinImpl dict_flatten_to_dict_factory(EastType **tp, size_t ntp)
{
    (void)tp;
    (void)ntp;
    return dict_flatten_to_dict_impl;
}
static BuiltinImpl dict_group_fold_factory(EastType **tp, size_t ntp)
{
    (void)tp;
    (void)ntp;

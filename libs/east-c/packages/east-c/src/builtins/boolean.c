...
static BuiltinImpl boolean_and_factory(EastType **tp, size_t ntp)
{
    (void)tp;
    (void)ntp;
    return boolean_and;
}
static BuiltinImpl boolean_or_factory(EastType **tp, size_t ntp)
{
    (void)tp;
    (void)ntp;
    return boolean_or;
}
static BuiltinImpl boolean_not_factory(EastType **tp, size_t ntp)
{
    (void)tp;
    (void)ntp;
    return boolean_not;
}
static BuiltinImpl boolean_xor_factory(EastType **tp, size_t ntp)
{
    (void)tp;
    (void)ntp;
    return boolean_xor;

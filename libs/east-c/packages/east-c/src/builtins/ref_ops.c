...
static BuiltinImpl ref_get_factory(EastType **tp, size_t ntp)
{
    (void)tp;
    (void)ntp;
    return ref_get_impl;
}
static BuiltinImpl ref_update_factory(EastType **tp, size_t ntp)
{
    (void)tp;
    (void)ntp;
    return ref_update_impl;
}
static BuiltinImpl ref_merge_factory(EastType **tp, size_t ntp)
{
    (void)tp;
    (void)ntp;
    return ref_merge_impl;
}

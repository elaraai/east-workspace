...
| `mcp/server.js` | MCP tool `search_east_examples` — same search, available as a tool |
...
When working with East code, use the mcp__plugin_east_east__search_east_examples

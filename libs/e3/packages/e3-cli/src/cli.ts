...
program
  ...
  .addCommand(
    new Command('deploy')
      ...
      .option('--functions <path...>', 'Function manifests (east-py / east-node export-functions) for East.importFunction packages built elsewhere; a package of this uv workspace is exported and linked by itself')
      .option('--quiet', 'Suppress progress and success output (errors only)')

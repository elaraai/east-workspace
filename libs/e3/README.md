...
e3 is an automated, durable execution engine for [East](https://github.com/elaraai/east-workspace/tree/main/libs/east) programs with cross-language runtime support.

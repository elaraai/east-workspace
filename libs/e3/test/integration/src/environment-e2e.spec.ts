...
import { ensureLocalStack, injectLocalNpmRegistry, injectLocalPythonIndex, stopLocalStack, type LocalStack } from './localStack.js';
...
/** Local stand-in registries serving THIS tree's @elaraai build; null when they
 *  cannot be built, in which case the env suites skip with a clear reason. */

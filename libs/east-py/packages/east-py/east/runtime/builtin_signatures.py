...
_SIGNATURES: dict[str, Any] = {
    ...
    "VectorScale": lambda T: [VectorType(T), T],
    "VectorSum": lambda T: [VectorType(T)],
    "VectorAddScaled": lambda T: [VectorType(T), VectorType(T), T],
    "VectorMul": lambda T: [VectorType(T), VectorType(T)],
    "VectorAddScalar": lambda T: [VectorType(T), T],
    "VectorDot": lambda T: [VectorType(T), VectorType(T)],
    "VectorMax": lambda T: [VectorType(T)],
    "VectorMin": lambda T: [VectorType(T)],
    "VectorArgMax": lambda T: [VectorType(T)],
    "VectorArgMin": lambda T: [VectorType(T)],
    "VectorMean": lambda T: [VectorType(T)],
    "VectorCumSum": lambda T: [VectorType(T)],
    "VectorAbs": lambda T: [VectorType(T)],
    "VectorClamp": lambda T: [VectorType(T), T, T],
    "VectorGather": lambda T: [VectorType(T), VectorType(IntegerType)],
    "VectorScatterAdd": lambda T: [VectorType(T), VectorType(IntegerType), VectorType(T)],
    "VectorSearchSorted": lambda T: [VectorType(T), VectorType(T)],
    "VectorEq": lambda T: [VectorType(T), VectorType(T)],
    "VectorLt": lambda T: [VectorType(T), VectorType(T)],
    "VectorGt": lambda T: [VectorType(T), VectorType(T)],
    "VectorSelect": lambda T: [VectorType(BooleanType), VectorType(T), VectorType(T)],
    "VectorCompress": lambda T: [VectorType(BooleanType), VectorType(T)],
    "VectorCountTrue": lambda: [VectorType(BooleanType)],
    "SparseAxpy": lambda T: [
        VectorType(IntegerType), VectorType(T), VectorType(IntegerType), VectorType(T), T,
    ],
    "SparseFromPairs": lambda T: [VectorType(IntegerType), VectorType(T)],
    "SparseFilterGt": lambda T: [VectorType(IntegerType), VectorType(T), T],
    # ── matrix ──
    ...
    "MatrixScale": lambda T: [MatrixType(T), T],
    "MatrixAddScaled": lambda T: [MatrixType(T), MatrixType(T), T],
    "MatrixMulElementwise": lambda T: [MatrixType(T), MatrixType(T)],

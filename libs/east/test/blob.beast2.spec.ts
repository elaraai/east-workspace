...
await describe("Blob (Beast v2)", (test) => {
  ...
  test("Beast v2 - UI component with onClick returning self type", $ => {
    ...
    $(assert.equal(blob, East.value(new Uint8Array([
      ...
      16,4,12,10,15,2,2,15,3,7,3,12,0,212,2,3,10,7,0,5,
      10,15,1,4,15,15,10,6,1,30,12,1,212,2,17,1,236,58,5,0,
      1,3,10,6,0,0,6,13,7,0,12,1,212,2,17,1,242,58,5,6,
      30,12,1,212,2,17,1,236,58,5,0,1,1,1,7,
    ]), BlobType)));
  ...
  test("Beast v2 - Recursive type with render callback and children", $ => {
    ...
    $(assert.equal(blob, East.value(new Uint8Array([
      ...
      1,16,3,2,15,16,10,15,2,3,0,12,0,222,2,4,7,4,12,0,
      222,2,4,10,8,1,8,15,10,7,1,30,12,1,222,2,17,2,148,60,
      5,0,1,10,10,7,1,30,8,152,60,6,0,0,0,0,13,7,1,12,
      1,222,2,17,2,156,60,5,6,30,12,1,222,2,17,2,148,60,5,0,
      1,1,1,7,
    ]), BlobType)));

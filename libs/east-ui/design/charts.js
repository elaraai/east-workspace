...
(function () {
  ...
  /* Pull palette from CSS tokens so a theme swap propagates.
   * Falls back to the original literals if a token is missing. */
  ...
  const C = {
    brand:    tok('--brand',       '#488e97'),
    brandD:   tok('--brand-d',     '#3a7780'),
    brandDD:  tok('--brand-dd',    '#2b4b55'),
    brandTint:tok('--brand-tint',  '#e8f6f7'),
    ink:      tok('--ink',         '#111b22'),
    ink3:     tok('--ink-3',       '#4a5f5f'),
    ink4:     tok('--ink-4',       '#6b8080'),
    ink5:     tok('--ink-5',       '#9bb0b0'),
    rule:     tok('--rule',        '#e2e8e8'),
    pos:      tok('--pos',         '#2f7a5b'),
    neg:      tok('--neg',         '#b85a4a'),
    paper:    tok('--paper',       '#ffffff')
  };

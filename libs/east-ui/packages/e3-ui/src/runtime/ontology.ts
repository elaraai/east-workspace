...
import { optionsTag, type OptionsProps, type JsxTag } from "@elaraai/east-ui/jsx";
...
export const Ontology: JsxTag<OptionsProps<typeof OntologyFactory.Root>> = optionsTag(OntologyFactory.Root);

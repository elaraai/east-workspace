...
function createFlex(
    ...
    return East.value(variant("Flex", {
        ...
        style: style ? variant("some", East.value({
            ...
            fill: style.fill !== undefined ? variant("some", style.fill) : variant("none", null),
            scroll: style.scroll !== undefined ? variant("some", style.scroll) : variant("none", null),
            scrollX: style.scrollX !== undefined ? variant("some", style.scrollX) : variant("none", null),
            scrollY: style.scrollY !== undefined ? variant("some", style.scrollY) : variant("none", null),

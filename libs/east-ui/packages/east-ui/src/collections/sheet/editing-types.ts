...
import { AsyncFunctionType, BlobType, BooleanType, EastTypeType, FunctionType, IntegerType, NullType, OptionType, StringType, StructType, VariantType } from "@elaraai/east";
...
export const SheetEditingType = StructType({
    ...
    readyRow: OptionType(FunctionType([BlobType], SheetReadinessType)),

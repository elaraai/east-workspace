...
import { Card, Library, Reactive, Roster, Text, VStack } from "@elaraai/east-ui";
...
export const rosterScroll = example({
    ...
    description: "Bounded roster (#320) — maxHeight=\"180px\" caps the component; eight people overflow so it clips mid-row and scrolls within (only the visible person rows mount)",
    fn: East.function([], UIComponentType, ($) => {
        const people = $.const([
...
export const rosterFill = example({
    keywords: ["Roster", "fill", "height", "Card", "bounded", "scroll", "sizing", "#320"],
    description: "height=\"fill\" (#320) — the roster fills a fixed 180px Card body and scrolls within it; eight people overflow so it clips mid-row",
    fn: East.function([], UIComponentType, ($) => {
        const people = $.const([
            { id: "patel", name: "Patel", target: "38h" }, { id: "cho", name: "Cho", target: "26h" },
            { id: "rivera", name: "Rivera", target: "32h" }, { id: "okafor", name: "Okafor", target: "24h" },

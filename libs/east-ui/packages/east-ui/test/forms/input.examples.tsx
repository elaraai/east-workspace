...
import { Input, Separator, Status, Text, VStack, HStack, Reactive } from "@elaraai/east-ui";
    ...
    fn: East.function([], UIComponentType, (_$) => {
        return (
            <VStack gap="4" align="stretch">
                <Separator label="STRING" align="start" />
                ...
                <Separator label="FLOAT" align="start" />
    ...
    fn: East.function([], UIComponentType, (_$) => {
        return (
            <VStack gap="4" align="stretch">
                ...
                <Separator label="FOCUSED" align="start" />
...
export const inputReactive = example({
    ...
    fn: East.function([], UIComponentType, (_$) => {
        return (
            <VStack gap="4" align="stretch">
                <Separator label="STRING INTERACTIVE" align="start" />
                <Reactive>{$ => {
                ...
                <Separator label="INTEGER INTERACTIVE" align="start" />
                <Reactive>{$ => {
                ...
                <Separator label="FLOAT INTERACTIVE" align="start" />
                <Reactive>{$ => {
                ...
                <Separator label="DATE TIME INTERACTIVE" align="start" />
                <Reactive>{$ => {

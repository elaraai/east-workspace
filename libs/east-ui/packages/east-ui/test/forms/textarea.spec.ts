...
describeEast("Textarea", (test) => {
    Assert.examples(test, {
        ...
        textareaVariants: ex.textareaVariants,
    });

    test("textareaVariants is the live configurator", $ => {
        const panel = $.const(ex.textareaVariants.fn() as ExprType<UIComponentType>);

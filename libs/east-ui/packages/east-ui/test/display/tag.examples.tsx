    ...
    fn: East.function([], UIComponentType, ($) => {
        ...
        return (
            <VStack gap="4" align="stretch">
                ...
                <VStack gap="1" align="stretch">
                    <Text textStyle="body-sm" fontFamily="mono" textTransform="uppercase" color="fg.muted">DYNAMIC</Text>
                    <VStack gap="3" align="flex-start">
                        <HStack gap="2">
...
export const tagClosable = example({
    ...
    fn: East.function([], UIComponentType, (_$) => {
        return (
            <VStack gap="4" align="stretch">
                <VStack gap="1" align="stretch">
                    <Text textStyle="body-sm" fontFamily="mono" textTransform="uppercase" color="fg.muted">CLOSABLE</Text>
                    <HStack gap="2">
                ...
                <VStack gap="1" align="stretch">
                    <Text textStyle="body-sm" fontFamily="mono" textTransform="uppercase" color="fg.muted">ON CLOSE INTERACTIVE</Text>
                    <Reactive>{$ => {

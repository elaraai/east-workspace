...
import { EditableChip, Text, HStack, VStack, Stack, Reactive } from "@elaraai/east-ui";
        ...
        return (
            <VStack gap="4" align="stretch">
                <VStack gap="1" align="stretch">
                    <Text textStyle="body-sm" fontFamily="mono" textTransform="uppercase" color="fg.muted">CHIP DISABLED</Text>
                    <EditableChip disabled={true}><Text>Locked assumption</Text></EditableChip>
                </VStack>
                <VStack gap="1" align="stretch">
                    <Text textStyle="body-sm" fontFamily="mono" textTransform="uppercase" color="fg.muted">CHIP STYLED</Text>
...
export const editableChipReactive = example({
    ...
    fn: East.function([], UIComponentType, ($) => {
        ...
        return (
            <VStack gap="4" align="stretch">
                <VStack gap="1" align="stretch">
                    <Text textStyle="body-sm" fontFamily="mono" textTransform="uppercase" color="fg.muted">CHIP WITH CALLBACK</Text>
                    <EditableChip onClick={onClick}><Text>Scenario: Q4 forecast</Text></EditableChip>
                </VStack>
                <VStack gap="1" align="stretch">
                    <Text textStyle="body-sm" fontFamily="mono" textTransform="uppercase" color="fg.muted">CHIP REACTIVE</Text>
                    <Reactive>{$ => {

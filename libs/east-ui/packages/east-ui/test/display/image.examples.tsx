...
const LOGO_SVG = "<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 64 64'><rect width='64' height='64' rx='14' fill='#0d9488'/><path d='M36 8 L18 38 h12 l-4 18 20-30 H34 z' fill='#ffffff'/></svg>";
...
const WIDE_SVG = "<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 120 40'><rect width='120' height='40' fill='#1e293b'/><circle cx='22' cy='20' r='13' fill='#f59e0b'/><rect x='44' y='14' width='66' height='12' rx='6' fill='#38bdf8'/></svg>";

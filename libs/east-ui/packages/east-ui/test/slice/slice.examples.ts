    ...
    fn: East.function([], UIComponentType, (_$) => {
        ...
        return Reactive.Root(East.function([], UIComponentType, $ => {
            ...
            return Stack.VStack([
                ...
                Slice.Filter.Root(slice, { unit: "events", density: "compact" }),
                Separator.Root({ orientation: "horizontal" }),
                Text.Presets.Eyebrow("FOCUSED · STANDALONE"),
                Slice.Filter.Root(slice, { unit: "events", density: "focused" }),
            ], { gap: "4", align: "stretch" });
        }));
    }),
    inputs: [],
    ...
    fn: East.function([], UIComponentType, (_$) => {
        ...
        return Reactive.Root(East.function([], UIComponentType, $ => {
            ...
            return Stack.VStack([
                ...
                Slice.Breakdown.Root(slice, { density: "compact" }),
                Separator.Root({ orientation: "horizontal" }),
                Text.Presets.Eyebrow("FOCUSED · STANDALONE"),
                Slice.Breakdown.Root(slice, { density: "focused" }),
            ], { gap: "4", align: "stretch" });
        }));
    }),
    inputs: [],
...
export const sliceSearch = example({
    ...
    fn: East.function([], UIComponentType, (_$) => {
        ...
        return Reactive.Root(East.function([], UIComponentType, $ => {
            ...
            return Stack.VStack([
                Text.Presets.Eyebrow("COMPACT · IN FRAME EYEBROW"),
                Slice.Search.Root(slice, { density: "compact" }),
                Separator.Root({ orientation: "horizontal" }),
                Text.Presets.Eyebrow("FOCUSED · STANDALONE"),
                Slice.Search.Root(slice, { recent: ["demand-spike", "SKU-022"], density: "focused" }),
            ], { gap: "4", align: "stretch" });
        }));
    }),
    inputs: [],
...
export const sliceCohort = example({
    ...
    fn: East.function([], UIComponentType, (_$) => {
        ...
        return Reactive.Root(East.function([], UIComponentType, $ => {
            ...
            return Slice.Cohort.Root(slice, { createdBy: "d.park", lastEdited: "09-08", reevaluateEvery: "every 10 min" });
        }));
    }),
    inputs: [],
});
...
export const sliceComposed = example({
    ...
    fn: East.function([], UIComponentType, (_$) => {
        ...
        return Reactive.Root(East.function([], UIComponentType, $ => {
            ...
            return Slice.Frame.Root(slice, Table.Root(filtered, {
...
export const sliceFrameNarrow = example({
    ...
    fn: East.function([], UIComponentType, (_$) => {
        ...
        return Reactive.Root(East.function([], UIComponentType, $ => {
            ...
            return Box.Root([
                Slice.Frame.Root(slice, Table.Root(filtered, {
                    scenario: { header: "Scenario" },
                    region:   { header: "Region" },
                    sessions: { header: "Sessions" },
                }), { affordances: ["filter", "search"] }),
            ], { width: "520px", maxWidth: "520px" });
        }));
    }),
    inputs: [],
});
    ...
    fn: East.function([], UIComponentType, (_$) => {
        ...
        return Reactive.Root(East.function([], UIComponentType, $ => {
            ...
            return Slice.Frame.Root(slice, Table.Root(filtered, {
                ...
                sessions:  { header: "Sessions" },
            }), { affordances: ["filter", "breakdown", "search"] });
        }));
    }),
    inputs: [],
});
    ...
    fn: East.function([], UIComponentType, (_$) => {
        ...
        return Reactive.Root(East.function([], UIComponentType, $ => {
            ...
            return Slice.Frame.Root(slice, Table.Root(filtered, {
                ...
                region:   { header: "Region" },
                sessions: { header: "Sessions" },
            }), { affordances: ["filter", "breakdown", "cohort", "range", "search"], collapsible: true });
        }));
    }),
    inputs: [],
});
...
export const sliceChartFrame = example({
    ...
    fn: East.function([], UIComponentType, (_$) => {
        ...
        return Reactive.Root(East.function([], UIComponentType, $ => {
            ...
            return Slice.Frame.Root(slice, Slice.Chart.Line(slice, { x: "month", value: "sessions", height: 150 }), { affordances: ["breakdown"] });
        }));
    }),
    inputs: [],
});

// Shared monthly-by-region fixture for the per-mark chart examples below.
const monthRegionRows = [
...
export const sliceChartBar = example({
    ...
    fn: East.function([], UIComponentType, (_$) => {
        ...
        return Reactive.Root(East.function([], UIComponentType, $ => {
            const data = $.const(monthRegionRows, ArrayType(EventType));
            const slice = $.let(Slice.bind([EventType], "ex.slice.chart.bar", cfg, Slice.state({
                breakdown: some({ fieldId: "region", limit: none }),
            }), data, none));
            return Slice.Frame.Root(slice, Slice.Chart.Bar(slice, { x: "month", value: "sessions", height: 150 }), { affordances: ["breakdown"] });
        }));
    }),
    inputs: [],
});
...
export const sliceChartArea = example({
    ...
    fn: East.function([], UIComponentType, (_$) => {
        ...
        return Reactive.Root(East.function([], UIComponentType, $ => {
            ...
            return Slice.Frame.Root(slice, Slice.Chart.Area(slice, { x: "month", value: "sessions", height: 150 }), { affordances: ["breakdown"] });
        }));
    }),
    inputs: [],
});
...
export const sliceChartScatter = example({
    ...
    fn: East.function([], UIComponentType, (_$) => {
        ...
        return Reactive.Root(East.function([], UIComponentType, $ => {
            ...
            return Slice.Frame.Root(slice, Slice.Chart.Scatter(slice, { x: "month", value: "sessions", height: 150 }), { affordances: ["breakdown"] });
        }));
    }),
    inputs: [],
});
...
export const sliceChartTime = example({
    ...
    fn: East.function([], UIComponentType, (_$) => {
        ...
        return Reactive.Root(East.function([], UIComponentType, $ => {
            ...
            return Slice.Frame.Root(slice, Slice.Chart.Line(slice, { x: "day", value: "sessions", xScale: "time", height: 150 }), { affordances: ["breakdown"] });
        }));
    }),
    inputs: [],
});
...
export const sliceChartLinearX = example({
    ...
    fn: East.function([], UIComponentType, (_$) => {
        ...
        return Reactive.Root(East.function([], UIComponentType, $ => {
            ...
            return Slice.Frame.Root(slice, Slice.Chart.Scatter(slice, { x: "spend", value: "sessions", xScale: "linear", height: 150 }), { affordances: ["breakdown"] });
        }));
    }),
    inputs: [],
});

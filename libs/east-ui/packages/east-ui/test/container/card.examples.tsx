...
import { Badge, Box, Button, Card, Separator, Text, HStack, VStack } from "@elaraai/east-ui";
    ...
    fn: East.function([], UIComponentType, (_$) => {
        return (
            <VStack gap="4" align="stretch">
                ...
                <Separator label="FOOTER" align="start" />
                <Card
                ...
                <Separator label="WITH COMPOUND HEADER" align="start" />
                <Card
                ...
                <Separator label="WITH SECTIONS" align="start" />
...
export const cardSizing = example({
    ...
    fn: East.function([], UIComponentType, (_$) => {
        return (
            <VStack gap="4" align="stretch">
                <Separator label="DIMENSIONS" align="start" />
                ...
                <Separator label="FLEXIBLE" align="start" />
                ...
                <Separator label="FILL BODY" align="start" />

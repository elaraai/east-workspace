...
import { OptionList, Reactive, State, Badge, Stack, Text, UIComponentType } from "@elaraai/east-ui";
    ...
    fn: East.function([], UIComponentType, (_$) => {
        return OptionList.Root([
            ...
            OptionList.Option("alt-3", "Add agency worker", {
                description: "+£480 variable cost, 0 unmet",
                trailing: Badge.Root("+£480", { colorPalette: "red" }),
            }),
        ], { selectedId: "alt-1" });
    }),
    inputs: [],
...
export const optionListWhatIf = example({
    ...
    fn: East.function([], UIComponentType, (_$) => {
        return OptionList.Root([
            ...
            OptionList.Option("w-2", "+10% demand shock", {
                description: "Adds 420 units / shift",
            }),
            OptionList.Option("w-3", "Outage on Line B", {
                description: "Not modelled yet",
                disabled: true,
            }),
        ], {
            selectedId: "w-1",
    ...
    fn: East.function([], UIComponentType, (_$) => {
        return Reactive.Root(East.function([], UIComponentType, $ => {
            ...
            return Stack.VStack([
                ...
                Text.Root(East.str`Selected: ${selected}`, { color: "fg.muted" }),
            ], { gap: "3", align: "stretch" });
        }));
    }),
    inputs: [],

...
────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
 ...
 /workspace <name>  switch workspace     tab ⇧tab  next/prev pane                ⇧←  collapse subtree                   
...
- **Layout** — the medium (80–99) and narrow (60–79) column plans are tighter than the 120-column design, and `fitPlan` narrows the widest fixed columns until the last column keeps 12 cells (untouched at 120).

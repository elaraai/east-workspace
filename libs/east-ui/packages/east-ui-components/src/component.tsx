...
import { EastChakraConfigurator } from "./layout/configurator";
...
import { EastChakraDock } from "./layout/dock";
...
export const EastChakraComponent = memo(function EastChakraComponent({ value, storageKey }: EastChakraComponentProps) {
    const rendered = useMemo(() => {
        return match(value, {
            ...
            Configurator: (v) => <EastChakraConfigurator value={v} storageKey={childKey(storageKey, "Configurator")} />,
            ...
            Dock: (v) => <EastChakraDock value={v} storageKey={childKey(storageKey, "Dock")} />,
            ...
            Image: (v) => <EastChakraImage value={v} />,
            ...
            Trace: (v) => <EastChakraTrace value={v} storageKey={childKey(storageKey, "Trace")} />,
